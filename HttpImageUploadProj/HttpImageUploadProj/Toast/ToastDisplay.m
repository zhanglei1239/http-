...
+ (void)showToast:(NSString *)message withColorType:(int)colorType superView:(UIView *)sView;
{
    ...
    [[ToastDisplay sharedToastDisplay] show:[[ToastDisplay sharedToastDisplay] makeViewOfMessage:message withColorType:colorType] superView:sView];
}
...
- (UILabel *)makeViewOfMessage:(NSString *)msg withColorType:(int)colorType
{
    ...
    UILabel * messageLabel = [[UILabel alloc] initWithFrame:CGRectMake(20,0, UI_SCREEN_WIDTH-40,CSToastHeight)];
...
- (void)show:(UILabel *)toast superView:(UIView *)sView{
    if (_isShowing) {
