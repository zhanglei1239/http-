...
{
    [self makeToast:message duration:CSToastDefaultDuration position:CSToastDefaultPosition withTextColor:color withValue:value];
}
...
{
    UIView *toast = [self viewForMessage:message title:nil image:nil color:color value:value];
...
{
    UIView *toast = [self viewForMessage:message title:title image:nil color:color value:value];
    [self showToast:toast duration:interval position:position];
}
...
{
    UIView *toast = [self viewForMessage:message title:nil image:image color:color value:value];
    [self showToast:toast duration:interval position:position];
}
...
{
    UIView *toast = [self viewForMessage:message title:title image:image color:color value:value];
    [self showToast:toast duration:interval position:position];
}
...
- (void)showToast:(UIView *)toast duration:(CGFloat)interval position:(id)point {
    ...
    [UIView animateWithDuration:CSToastFadeDuration
                    ...
                    animations:^{
                        ...
                        [UIView animateWithDuration:.8f delay:CSToastDefaultDuration  options:UIViewAnimationOptionCurveEaseIn animations:^{
